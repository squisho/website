...
const Projects = () => {
    return (
        <div>
        <Grid container direction="column" spacing={2.5} paddingTop={5}>
                <Grid container direction="row" name="DevXP" justifyContent="center" alignItems="center" rowSpacing={0}>
                    <Grid item style={{display:'flex', justifyContent:'center'}} xs={2}> {/*style={{display:'flex',justifyContent:'center',alignItems:'center'}} */}
                        <img width="150px" src="content/devxp.png" alt="DevXP Logo"></img>
                    </Grid>
                    <Grid item xs={4}>
                        <h1>DevXP</h1>
                ...
                <Grid item container direction="row" name="infovis" justifyContent="center" alignItems="center" sapcing={1}>
                <Grid item xs={4}>
                        <h1>InfoVis</h1>
                ...
                <Grid item container direction="row" name="psyc" justifyContent="center" alignItems="center" sapcing={1}>
                    <Grid item style={{display:'flex', justifyContent:'center'}} xs={2}>
                        <img width="150px" src="content/devxp.png" alt="DevXP Logo"></img>
                    </Grid>
                    <Grid item xs={4}>
                ...
                <Grid item container direction="row" name="soundboy" justifyContent="center" alignItems="center" sapcing={1}>
                <Grid item xs={4}>
                        <h1>SoundBoy</h1>
